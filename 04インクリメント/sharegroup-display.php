...
<form action="sharegroup-display2.php" method="post">
<div class="container mt-3">
    <h2 class="test">グループ名とパスワードを入力してください</h2><br>
</div>
<div class="container mt-3">
    <input type="text" name="group_name" placeholder="グループ名"><br><br>
</div>
<div class="container mt-3">
    ...
    <div class="container mt-3">
    <a href="sharegroup-addition.php">グループを新規登録</a>
    </div>
    <?php
    if(isset($message)){
