...
<head>
  <meta charset="utf-8">
  <title>カレンダー</title>
  <link href="DaysShare/css/style.css" rel="stylesheet" type="text/css">
</head>
...
<body>
  ...
  <button type="button" class="btn btn-outline-dark" type="button" onclick="location.href='addapointment.php'">　　予定を追加する　　</button>
</body>
</html>
