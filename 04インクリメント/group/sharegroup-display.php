...
<form action="sharegroup_dislog_check.php" method="post">
<div class="container mt-3">
    <h2 class="test">グループIDパスワードを入力してください</h2><br>
</div>
<div class="container mt-3">
...
<div class="container mt-3">
    ...
    <div class="container mt-3">
    <a href="../group/sharegroup-addition.php">グループを新規登録</a>
    </div>
    <?php
    if(isset($message)){
